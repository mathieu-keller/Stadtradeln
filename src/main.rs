...
async fn hello() -> impl Responder {
    println!("get request");
    let request_url = format!("http://192.168.178.36:8080/convert/html2image?u=doctron&p=lampnick&customClip=true&clipX=0&clipY=0&clipWidth=415&clipHeight=415&clipScale=2&format=jpeg&Quality=80&url=https%3A%2F%2Fwww.stadtradeln.de%2Ffileadmin%2Fradelkalender%2Fembed%2Fradelmeter-team.php%3Fsr_team_id%3D83474%26L%3D2");
